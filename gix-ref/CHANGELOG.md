...
- Add default-enabled, C-backed reftable reads, reflogs, linked-worktree routing, and reference transactions.
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2389 from GitoxideLabs/gix-error ([`dfeefe2`](https://github.com/GitoxideLabs/gitoxide/commit/dfeefe279c913e97ad6da677f7528db3c7eb57e2))
    - Adapt to changes in `gix-ref` ([`931c69b`](https://github.com/GitoxideLabs/gitoxide/commit/931c69bf0fe53bbfe67a79f38ae5c54a4c02feb7))
...
### New Features
 ...
 - <csr-id-d2cd2effb00bc15c80fc36870c943d4d2e236c41/> `Category::to_full_name()` can now be passed a full name without prefix duplication.
 ...
 * **Uncategorized**
    ...
    - `Category::to_full_name()` can now be passed a full name without prefix duplication. ([`d2cd2ef`](https://github.com/GitoxideLabs/gitoxide/commit/d2cd2effb00bc15c80fc36870c943d4d2e236c41))
...
### New Features
 ...
 - <csr-id-e179f825f7f560cd424a004d9c5184dd93013824/> replace peel_to_x_in_place by peel_to_x
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2196 from GitoxideLabs/copilot/fix-713956e8-cf8b-499a-99a8-92001948c9f8 ([`0a576b9`](https://github.com/GitoxideLabs/gitoxide/commit/0a576b968e61e9a675ae630bae3f6c0fd9422ac3))
    - Refactor ([`e670294`](https://github.com/GitoxideLabs/gitoxide/commit/e670294d5f0dc2350227dfcfbf6b659a8988e2f4))
    - Implement Display trait for reference name types ([`b813339`](https://github.com/GitoxideLabs/gitoxide/commit/b8133392910605fe1559d7f320ee23849c9e81a7))
    ...
    - Replace peel_to_x_in_place by peel_to_x ([`e179f82`](https://github.com/GitoxideLabs/gitoxide/commit/e179f825f7f560cd424a004d9c5184dd93013824))
    ...
    - Validate what happens if a rename is emulated, particularly in relation to directory creation. ([`e25ccbf`](https://github.com/GitoxideLabs/gitoxide/commit/e25ccbf3873a48e0dc1d54ece477d7202349eb33))
    - Merge pull request #2114 from EliahKagan/test-ref-storage-newline ([`d8fbe1e`](https://github.com/GitoxideLabs/gitoxide/commit/d8fbe1e7b74802c69cb84ecc3aa387d94e9d85e2))
    - Test that loose refs are written with a trailing newline ([`df91659`](https://github.com/GitoxideLabs/gitoxide/commit/df916595f6515f23a8dbf6f8588ccbac7c21953e))
...
### Bug Fixes
 ...
 - <csr-id-1fbb9464d45237c6aa53b98e5a555b774099ad11/> make sure ordinary capitalized partial names can be found by partial name.
...
<csr-id-65f69f72a8a08b3b2462362ec10d1748be48019b/>
...
### New Features (BREAKING)
 ...
 - <csr-id-7523e5c5cd1980b87e8afff914827330e0d9bd8c/> support for `precompose_unicode`, which is now an extra argument in the `Store` constructor.
 ...
 * **[#301](https://github.com/GitoxideLabs/gitoxide/issues/301)**
    ...
    - See what it means to use `Cow<PartialNameRef>` ([`2ae129a`](https://github.com/GitoxideLabs/gitoxide/commit/2ae129ad6183f36179031ea905d8974705e70da8))
    - All custom TryFrom implementations for Cow<PartialNameRef> ([`15afec1`](https://github.com/GitoxideLabs/gitoxide/commit/15afec1efbc01fbb52af8f88720c874e6aa2d2b1))
 ...
 * **Uncategorized**
    ...
    - A sketch to show how Cow<FullNameRef> could work ([`c6b2705`](https://github.com/GitoxideLabs/gitoxide/commit/c6b27058884b23cd3ee35ddc3aa2aaf69012cbff))
    ...
    - [ref #152] FAIL: cleanup iter API by allowing Option<packed::Buffer> ([`1836243`](https://github.com/GitoxideLabs/gitoxide/commit/1836243b6ec42eaf162463cded4a613c8984ac3a))
    ...
    - Revert "[git-ref] refactor (Option<Result… -> Result<Option…" ([`d4046e9`](https://github.com/GitoxideLabs/gitoxide/commit/d4046e94eb22d9e9b65ffa9861400c4fde4d0bd7))
    - [git-ref] refactor (Option<Result… -> Result<Option… ([`774e86c`](https://github.com/GitoxideLabs/gitoxide/commit/774e86ce78159f7e07ec552c1847658b6f9ac288))
    - [git-ref] refactor ([`928b637`](https://github.com/GitoxideLabs/gitoxide/commit/928b63789237b808b296c60c989b853b78d39f0e))
    - [git-ref] more docs ([`f962c74`](https://github.com/GitoxideLabs/gitoxide/commit/f962c74215965f14e8f136ab0a4eddfbba97e8c2))
    - [git-ref] refactor ([`415f15a`](https://github.com/GitoxideLabs/gitoxide/commit/415f15aa5751ee1a58d9e6723a9da9f3407a4d66))
    - [git-ref] a bunch of docs ([`7cfc5ab`](https://github.com/GitoxideLabs/gitoxide/commit/7cfc5ab3c3b969e968b894161f73f3c69fe8e4c9))
    - Thanks clippy ([`93915fa`](https://github.com/GitoxideLabs/gitoxide/commit/93915fa6f1c00260e4f263ac4837c2ae7916b764))
    - [git-ref] peel to id done ([`f74771c`](https://github.com/GitoxideLabs/gitoxide/commit/f74771c8caccb090066b5209721b8973c047f00c))
    - [git-ref] first working peel-to-id() ([`3574f87`](https://github.com/GitoxideLabs/gitoxide/commit/3574f8717700ae3b33e167be2442c69f604f287c))
    - [git-ref] frame for peel_to_id ([`3710b6c`](https://github.com/GitoxideLabs/gitoxide/commit/3710b6cfe5cf2e5e6f9199255ebb4ca68a195be5))
    - [git-ref] peeling without an iterator, fine ([`b118946`](https://github.com/GitoxideLabs/gitoxide/commit/b118946ef68425ffa0a606d67df7b5d3b2d851df))
    - [git-ref] first stab at reference iteration… ([`806d10e`](https://github.com/GitoxideLabs/gitoxide/commit/806d10ef735caf3575b84de0cca5b55374140571))
    - [git-ref] refactor ([`c363269`](https://github.com/GitoxideLabs/gitoxide/commit/c363269e118a2dc53ce29ba245c079cecf061b7e))
    - [git-ref] find_one_existing(…) for convenience ([`7a443ff`](https://github.com/GitoxideLabs/gitoxide/commit/7a443ffc148ae8161ba93351ffd16631f79e095c))
    - [git-ref] some find failure cases ([`d855051`](https://github.com/GitoxideLabs/gitoxide/commit/d85505195541f3123527a337c9935e25bfc40ec4))
    - [git-ref] handle all find_one cases as per docs ([`3c0acc6`](https://github.com/GitoxideLabs/gitoxide/commit/3c0acc6545ede1a3fef25ace2b7dbf79debdc754))
    - [git-ref] more ways of finding reference ([`b3c4e92`](https://github.com/GitoxideLabs/gitoxide/commit/b3c4e928c6fb01e029f509e8b24516cd6c24e48f))
    - [git-ref] the first green find_one test ([`30177e8`](https://github.com/GitoxideLabs/gitoxide/commit/30177e81451bd4fb51dd3297502fa3c63f67286e))
    - Thanks clippy ([`8f0e9ed`](https://github.com/GitoxideLabs/gitoxide/commit/8f0e9ed9220a874e8437ede6e129d345e9c8f737))
    - [git-ref] first basic impl shows validation needs a little adjustment ([`8b901c7`](https://github.com/GitoxideLabs/gitoxide/commit/8b901c750f97a950cb162c9195770aee451d2e7e))
    - [git-ref] a sketch of find_one - easiest for the caller for sure ([`ec96256`](https://github.com/GitoxideLabs/gitoxide/commit/ec96256c4be9ff6de15bb698f2d3b9559619a042))
    - [git-ref] refactor ([`5bac585`](https://github.com/GitoxideLabs/gitoxide/commit/5bac5851367d77ead43feceefdb2bfaf24a1561e))
    - [git-ref] frame for loose store reference lookup ([`30b0d54`](https://github.com/GitoxideLabs/gitoxide/commit/30b0d54ed04916a858af3101345c677dbf48594d))
    - (cargo-release) version 0.2.0 ([`1327894`](https://github.com/GitoxideLabs/gitoxide/commit/132789475400abe660b30ef6d2c5ff57821dd2c4))
    - [git-ref] use git-validate crate ([`6b4f937`](https://github.com/GitoxideLabs/gitoxide/commit/6b4f937f13ad62bc2c7e5b0fc14416feb9c313ba))
    - [git-ref] Setup more tests to realize we really want validate::tag ([`54ee5b5`](https://github.com/GitoxideLabs/gitoxide/commit/54ee5b5eace8c35bc33ef1261778ba0fcee2ef37))
    - [git-ref] frame for validation ([`9656ac6`](https://github.com/GitoxideLabs/gitoxide/commit/9656ac620a1a085122676052b9a0b32d9c4f6661))
    - [git-ref] failure tests ([`567e86c`](https://github.com/GitoxideLabs/gitoxide/commit/567e86caf83c73497b021d636ea440cc817f10ba))
    - [git-ref] more tests ([`048fb77`](https://github.com/GitoxideLabs/gitoxide/commit/048fb775764004ec5bb39bf243a102233dd9946c))
    - [git-ref] refactor ([`77d0cc0`](https://github.com/GitoxideLabs/gitoxide/commit/77d0cc088d6de8c37fec9ae0136c9f85bfdbc643))
    - [git-ref] don't support serde for now ([`2a6295b`](https://github.com/GitoxideLabs/gitoxide/commit/2a6295bbd8a30d84c0d6544ca83e79146aff088e))
    - [git-ref] refactor ([`02e545b`](https://github.com/GitoxideLabs/gitoxide/commit/02e545ba6fe801f43e0a76e43e8bcfaaf77bd5f5))
    - [git-ref] first basic 'ref: ' parsing ([`60fa3ba`](https://github.com/GitoxideLabs/gitoxide/commit/60fa3bac9bfff7b5e3ac331c77c1050e9359f481))
    - [git-ref] refactor ([`9a30f87`](https://github.com/GitoxideLabs/gitoxide/commit/9a30f87292aff1d4a2f043ba160df6b09bce16c8))
    - [git-ref] the first succeeding test ([`cebfdb4`](https://github.com/GitoxideLabs/gitoxide/commit/cebfdb463ac2d86f56bb3a2d57c0487a8b233fd8))
    ...
    - [git-ref] sketch ref creation ([`c5241b8`](https://github.com/GitoxideLabs/gitoxide/commit/c5241b835b93af497cda80ce0dceb8f49800df1c))
    - [git-ref] A sketch of how it looks like with Store backref ([`1a08f1c`](https://github.com/GitoxideLabs/gitoxide/commit/1a08f1c0365afe7d5e6fbc80bdd382d193d4b881))
    - [git-ref] more scaffolding ([`8c6e884`](https://github.com/GitoxideLabs/gitoxide/commit/8c6e8844627878e981e597de0c29408cf51582a4))
    - [git-ref] clear it out and move existing functionality to git-object ([`fa548ce`](https://github.com/GitoxideLabs/gitoxide/commit/fa548ce94db3dd3969add494756fcc34e48985a3))
    - (cargo-release) version 0.5.0 ([`b6b5856`](https://github.com/GitoxideLabs/gitoxide/commit/b6b58560b7c3bc88e2b8b780be5ceb4cb508a346))
    - [pack-gen] refactor ([`61554e2`](https://github.com/GitoxideLabs/gitoxide/commit/61554e2effcbafef9cff0b407351c2fae0d2916c))
    - (cargo-release) version 0.4.1 ([`25d2c2e`](https://github.com/GitoxideLabs/gitoxide/commit/25d2c2e6ae70f46869ab0dabdda2b9f7840539d3))
    - Document `git-ref` ([`91dce23`](https://github.com/GitoxideLabs/gitoxide/commit/91dce23c8faf74511c33e5cfa07d2f293b1cd0a2))
    ...
    - (cargo-release) version 0.4.0 ([`f9dd225`](https://github.com/GitoxideLabs/gitoxide/commit/f9dd225afc4aafde1a8b8148943f56f2c547a9ea))
    ...
    - Refactor ([`63c1292`](https://github.com/GitoxideLabs/gitoxide/commit/63c129292288cc626b09ad29e9ef5f1a1d8339e4))
    ...
    - (cargo-release) version 0.2.0 ([`d350a13`](https://github.com/GitoxideLabs/gitoxide/commit/d350a13784685ea82b84646b18736986aeb68146))
    ...
    - Assert we don't exeed package sizes ([`df66d74`](https://github.com/GitoxideLabs/gitoxide/commit/df66d74aa2a8cb62d8a03383135f08c8e8c579a8))
    - Refactor ([`6ad9304`](https://github.com/GitoxideLabs/gitoxide/commit/6ad93041813f78548c3bd813b8685a60d857336f))
    - Refactor ([`1fd90f7`](https://github.com/GitoxideLabs/gitoxide/commit/1fd90f739f4d8bb7c4f27103d2bb92e3f58b6f68))
    - Test for common ascii control characters ([`ae0c885`](https://github.com/GitoxideLabs/gitoxide/commit/ae0c885518d9ce4de05adbb048c0188f9ca934c3))
    - All test for valid ref name except for ascii control chars ([`a157acf`](https://github.com/GitoxideLabs/gitoxide/commit/a157acfb1f68ec6af6bb0b76f52aa8c7f72d43bf))
    - Add new 'git-ref' crate; place ref name validation code there ([`1a0e84e`](https://github.com/GitoxideLabs/gitoxide/commit/1a0e84e627b17be1b1fb53b4dc98ab78e9cfb9a7))
</details>
